...
public final class ZLTextPlainModel implements ZLTextModel, ZLTextStyleEntry.Feature {
	...
	private int[] myStartEntryIndices;//每个段落具体在CachedCharStorage类内部的哪一个char数组里面
	private int[] myStartEntryOffsets;//每个段落从CachedCharStorage类内部char数组的哪个位置开始
	private int[] myParagraphLengths;//每个段落在CachedCharStorage类内部char数组中占据多少长度
